    ...
    return (
      <div className="space-y-4">
        ...
        {product.imageUrl && (
          <Card size="sm">
            <CardHeader>
              <CardTitle>Texte alternatif de l&apos;image</CardTitle>
              <CardAction>
                <Button
                  type="button"
                  variant="ghost"
            ...
            <CardContent>
              <Field>
                ...
                />
                <FieldDescription>
                  Ce texte sera affiché si l&apos;image ne se charge pas et aide
                  au référencement.
                </FieldDescription>
        ...
        <Card size="sm">
          ...
          <CardContent>
            <Field>
              ...
              />
              <FieldDescription>
                Utilisé dans l&apos;URL du produit. Uniquement lettres
